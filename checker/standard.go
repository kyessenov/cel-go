...
func StandardDeclarations() []*exprpb.Decl {
	...
	return append(idents, []*exprpb.Decl{
		...
		decls.NewFunction(operators.Equals,
			decls.NewOverload(overloads.EqualsBool,
				[]*exprpb.Type{decls.Bool, decls.Bool}, decls.Bool),
			decls.NewOverload(overloads.EqualsInt64,
				[]*exprpb.Type{decls.Int, decls.Int}, decls.Bool),
			decls.NewOverload(overloads.EqualsUint64,
				[]*exprpb.Type{decls.Uint, decls.Uint}, decls.Bool),
			decls.NewOverload(overloads.EqualsDouble,
				[]*exprpb.Type{decls.Double, decls.Double}, decls.Bool),
			decls.NewOverload(overloads.EqualsString,
				[]*exprpb.Type{decls.String, decls.String}, decls.Bool),
			decls.NewOverload(overloads.EqualsBytes,
				[]*exprpb.Type{decls.Bytes, decls.Bytes}, decls.Bool),
			decls.NewOverload(overloads.EqualsTimestamp,
				[]*exprpb.Type{decls.Timestamp, decls.Timestamp}, decls.Bool),
			decls.NewOverload(overloads.EqualsDuration,
				[]*exprpb.Type{decls.Duration, decls.Duration}, decls.Bool)),
		decls.NewFunction(operators.NotEquals,
			decls.NewOverload(overloads.NotEqualsBool,
				[]*exprpb.Type{decls.Bool, decls.Bool}, decls.Bool),
			decls.NewOverload(overloads.NotEqualsInt64,
				[]*exprpb.Type{decls.Int, decls.Int}, decls.Bool),
			decls.NewOverload(overloads.NotEqualsUint64,
				[]*exprpb.Type{decls.Uint, decls.Uint}, decls.Bool),
			decls.NewOverload(overloads.NotEqualsDouble,
				[]*exprpb.Type{decls.Double, decls.Double}, decls.Bool),
			decls.NewOverload(overloads.NotEqualsString,
				[]*exprpb.Type{decls.String, decls.String}, decls.Bool),
			decls.NewOverload(overloads.NotEqualsBytes,
				[]*exprpb.Type{decls.Bytes, decls.Bytes}, decls.Bool),
			decls.NewOverload(overloads.NotEqualsTimestamp,
				[]*exprpb.Type{decls.Timestamp, decls.Timestamp}, decls.Bool),
			decls.NewOverload(overloads.NotEqualsDuration,
				[]*exprpb.Type{decls.Duration, decls.Duration}, decls.Bool)),
